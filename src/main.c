...
static const struct bt_uuid_128 nus_svc_uuid          = BT_UUID_INIT_128(BT_UUID_128_ENCODE(0x6E400001, 0xB5A3, 0xF393, 0xE0A9, 0xE50E24DCCA9E));

static const struct bt_uuid_128 Nus_service_WriteChar = BT_UUID_INIT_128(BT_UUID_128_ENCODE(0x6E400002,0xB5A3,0xF393,0xE0A9,0xE50E24DCCA9E));

static const struct bt_uuid_128 Nus_service_ReadChar  = BT_UUID_INIT_128(BT_UUID_128_ENCODE(0x6E400003,0xB5A3,0xF393,0xE0A9,0xE50E24DCCA9E));
...
static ssize_t write_nux_char(struct bt_conn *conn, const struct bt_gatt_attr *attr,                     //write char value
...
static ssize_t read_nux_char(struct bt_conn *conn, const struct bt_gatt_attr *attr,                      //#read char value
...
BT_GATT_SERVICE_DEFINE(nus_svc,
	...
	BT_GATT_CHARACTERISTIC(&Nus_service_WriteChar.uuid, BT_GATT_CHRC_WRITE,BT_GATT_PERM_WRITE, NULL, write_nux_char, NULL),
	BT_GATT_CHARACTERISTIC(&Nus_service_ReadChar.uuid, BT_GATT_CHRC_READ|BT_GATT_CHRC_NOTIFY,BT_GATT_PERM_READ, read_nux_char, NULL, test_char1_value),
...
int BtSetBattery(int level) 
{
    if (_IsTxEnabled == true) 
	{
        ...
        int rc = bt_gatt_notify(NULL, &nus_svc.attrs[3], test_char1_value, strlen(test_char1_value));
